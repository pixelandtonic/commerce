...
class BaseFrontEndController extends BaseController
{
    ...
    {
        // If they are specifying a site param set the current site
        if ($site = Craft::$app->getRequest()->getQueryParam('site')) {
            // This will accept an ID or handle and throw if the site doesn't exist
            Craft::$app->getRequest()->sites->setCurrentSite($site);
        }
