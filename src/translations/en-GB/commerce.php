...
return [
    ...
    'There aren’t any product types to select yet.' => 'There are no product types to select yet.',
    ...
    'What this catalog pricing rule will be called in the control panel.' => 'What this catalogue pricing rule will be called in the control panel.',
    ...
    'Whether this catalog pricing rule should be available for use, regardless of other conditions.' => 'Whether this catalogue pricing rule should be available for use, regardless of other conditions.',
    ...
    '{num, plural, =1{Order} other{Orders}} updated.' => '{num, plural, one {}=1{order} other{orders}} updated.',
