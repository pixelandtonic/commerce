...
return [
    ...
    'Add catalog price' => 'Add catalog price',
    ...
    'Can not move between these inventory types.' => 'Can not move between these inventory types.',
    ...
    'Catalog pricing rules updated.' => 'Catalog pricing rules updated.',
    ...
    'Create catalog pricing rules' => 'Create catalog pricing rules',
    ...
    'Date from which the catalog pricing rule will be active. Leave blank for unlimited start date' => 'Date from which the catalog pricing rule will be active. Leave blank for unlimited start date',
    ...
    'Date when the catalog pricing rule will be finished. Leave blank for unlimited end date' => 'Date when the catalog pricing rule will be finished. Leave blank for unlimited end date',
    ...
    'Default' => 'Default',
    'Default?' => 'Default?',
    'Delete catalog pricing rules' => 'Delete catalog pricing rules',
    ...
    'Edit catalog pricing rules' => 'Edit catalog pricing rules',
    ...
    'No catalog pricing rule exists with the ID “{id}”' => 'No catalog pricing rule exists with the ID “{id}”',
    'No catalog pricing rules exist yet.' => 'No catalog pricing rules exist yet.',
    ...
    'Other Field Layouts' => 'Other Field Layouts',
    ...
    'Shipping Address Zone' => 'Shipping Address Zone',
    ...
    'Show related sales' => 'Show related sales',
    ...
    'Site store mapping saved.' => 'Site store mapping saved.',
    'Sites' => 'Sites',
    'Slug' => 'Slug',
    'Snapshot' => 'Snapshot',
    'Snapshots' => 'Snapshots',
    ...
    'Source - The purchasable relationship field is on the category' => 'Source - The purchasable relationship field is on the category',
    'Source' => 'Source',
    ...
    'The from and to inventory locations must be different.' => 'The from and to inventory locations must be different.',
    ...
    'To' => 'To',
    'Today' => 'Today',
    'Too many variants for this product.' => 'Too many variants for this product.',
    ...
    'Updated committed stock successfully.' => 'Updated committed stock successfully.',
    'Updated' => 'Updated',
    'Use Billing Address For Tax' => 'Use Billing Address For Tax',
    ...
    'Validate Business Tax ID as Vat ID' => 'Validate Business Tax ID as Vat ID',
    ...
    'What this catalog pricing rule will be called in the control panel.' => 'What this catalog pricing rule will be called in the control panel.',
    ...
    'Whether this catalog pricing rule should be available for use, regardless of other conditions.' => 'Whether this catalog pricing rule should be available for use, regardless of other conditions.',
